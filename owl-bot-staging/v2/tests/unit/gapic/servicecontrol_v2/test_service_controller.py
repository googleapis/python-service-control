...
from google.api.servicecontrol_v2.services.service_controller import ServiceControllerAsyncClient
from google.api.servicecontrol_v2.services.service_controller import ServiceControllerClient
...
def test_service_controller_client_client_options_from_dict():
    with mock.patch('google.api.servicecontrol_v2.services.service_controller.transports.ServiceControllerGrpcTransport.__init__') as grpc_transport:
...
def test_service_controller_base_transport():
    ...
    with mock.patch('google.api.servicecontrol_v2.services.service_controller.transports.ServiceControllerTransport.__init__') as Transport:
...
def test_service_controller_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.api.servicecontrol_v2.services.service_controller.transports.ServiceControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_service_controller_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.api.servicecontrol_v2.services.service_controller.transports.ServiceControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ServiceControllerTransport()
        adc.assert_called_once()
