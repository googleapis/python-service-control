...
class ServiceControllerClient(metaclass=ServiceControllerClientMeta):
    ...
    def check(
        ...
        *,
        ...
        Args:
            request (Union[google.api.servicecontrol_v2.types.CheckRequest, dict]):
        ...
        Returns:
            google.api.servicecontrol_v2.types.CheckResponse:
    ...
    def report(
        ...
        *,
        ...
        Args:
            request (Union[google.api.servicecontrol_v2.types.ReportRequest, dict]):
        ...
        Returns:
            google.api.servicecontrol_v2.types.ReportResponse:
